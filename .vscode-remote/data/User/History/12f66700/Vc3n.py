...
def home_page(pokemon_id):
  ...
  if pokemon_id is not None:
    ...
    if selected_pokemon:
      return render_template("home.html",  all_pokemon=pokemon_data,poke=pokemon_id,mypokes=pokeees)
  selected_pokemon=pokemon_data[0]
  return render_template("home.html", all_pokemon=pokemon_data,poke=pokemon_id,mypokes=pokees)
...
def rename_action(pokemon_id):
  ...
  flash('${pokemon.name} renamed to ${name}')
